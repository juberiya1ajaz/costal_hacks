...
function CleanBeach() {
    ...
    // Model URL: https://teachablemachine.withgoogle.com/models/k4EwxTx-_/
    return (
        <div>
            {file.name ? (
                ...
                <div className="grid place-items-center">
                    ...
                    <div className="py-6">
                        ...
                        <h2 className='text-white text-center text-3xl py-5'>Choose a file of an Dirty Beach</h2>
